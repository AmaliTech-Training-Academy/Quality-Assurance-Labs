...
- Automation the test using Selenium WebDriver
...
| Test Automation Set up Folder structure (POM) Test Test data GitHub actions for CI pipeline Containerization with Docker | 70 |  |
| Generate automated test report | 20 |  |
