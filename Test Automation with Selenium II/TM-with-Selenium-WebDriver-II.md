...
Access the bank app here: [XYZ Bank App](https://www.globalsqa.com/angularJs-protractor/BankingProject/)
...
| **METRIC** | **SCORE** | **TOTAL** |
| --- | --- | --- |
| Generate a Test plan document for the project | 10 | 100 |
| Test Automation — Set up, Folder structure (POM), Test data, GitHub actions for CI pipeline, Containerization with Docker | 70 |  |
